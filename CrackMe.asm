...
; 1) коллизия хэша
; 2) переполнение буффера около пароля
; 3) перезатереть внутри .com jne fail_case
; 4) 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
; 1) написать еще два бага
; 2) разобраться с fsml
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

; 1) переполнение буфера путем ввода пароля
; 2)  
Start: 
                ...
                ; считываем пароль
                mov  si, offset user_buffer ; 1A4h
                call enter_password         
                ...
                ; user_buffer db 7 dup(0) ; добавил увязвимость. теперь если написать 123456ded -> success 
